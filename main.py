...
from bot_core import (
    ...
    handle_manual_trade, handle_backtest, handle_ce_sweep, handle_ut_sweep,
...
from strategies import (
    ...
    range_profile_poll_loop, binance_1s_poll_loop, zscore_trend_poll_loop, blsh_trend_poll_loop,
    trend_meter_poll_loop, stf_poll_loop, ce_poll_loop, ut_poll_loop, wtc_poll_loop, sg_poll_loop,
)
...
async def main():
    ...
    await asyncio.gather(
        ...
        *[blsh_trend_poll_loop(s) for s in SYMBOLS],
        *[trend_meter_poll_loop(s) for s in SYMBOLS],
